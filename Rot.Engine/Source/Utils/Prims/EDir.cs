...
namespace Rot.Engine
{
	...
	public struct EDir : IEquatable<EDir>
    {
        ...
        public static EDir fromInt(int n)
        {
            switch (n)
            {
                case 0: return EDir.N;
                case 1: return EDir.NE;
                case 2: return EDir.E;
                case 3: return EDir.SE;
                case 4: return EDir.S;
                case 5: return EDir.SW;
                case 6: return EDir.W;
                case 7: return EDir.NW;
                default: throw new Exception("Dir.random error");
            }
        }
